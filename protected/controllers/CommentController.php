...
class CommentController extends Controller
{
	...
	{
		return array(
			array('allow',  // allow all users to perform 'index', 'view', and feed actions
	 ...
	 * @return string RSS formatted XML feed and headers.
	 */
	public function actionFeed()
	{
		...
		// convert from an array of comment AR class instances to a
		...
		foreach($comments as $comment) {
			$entries[] = array(
				...
				'description' => $comment->author->username . ' said:<br>' . $comment->content,
		...
		$feed = Zend_Feed::importArray(
			array(
				'title' => 'Project Tracker Comments Feed',
