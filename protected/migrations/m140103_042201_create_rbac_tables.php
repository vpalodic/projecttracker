...
class m140103_042201_create_rbac_tables extends CDbMigration
{
	public function up()
	{
		...
		// the auth_assignment.itemname is a reference to auth_item.name
		$this->addForeignKey("fk_auth_assignment_itemname",
							 "auth_assignment",
							 "itemname",
							 "auth_item",
							 "name",
		...
		// the auth_assignment.userid is a reference to user.id
		$this->addForeignKey("fk_auth_assignment_userid",
							 "auth_assignment",
							 "userid",
							 "user",
							 "id",
